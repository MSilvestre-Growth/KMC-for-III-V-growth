...
class CustomRateCalculator(KMCRateCalculatorPlugin):
    ...
    def rate(self, geometry, elements_before, elements_after, rate_constant, process_number, coordinate):
        ...
        if process_number % Nb_processes_per_type < 18:
            return 0
        ...
        if is_in_bulk < 3 and process_number % Nb_processes_per_type == 18 : 
            
            print "process 18"
            
            print "concerned dimere"
        ...
        if is_in_bulk < 3 and process_number % Nb_processes_per_type == 19 :  
