...
config = KMCConfigurationFromScript("config_4_steps_40x40.py")
...
control_parameters = KMCControlParameters(number_of_steps=number_of_steps1,
                                          dump_interval=number_of_steps1/100,
                                          seed=596312)
t1 = time.clock()
name = "Results_steps_%lg" %number_of_steps1 + "_Flux_%lg" %SendFlux + "_T°K_%lg" %T + "_En_%lg" %E_normal + "_Ep_%lg" %E_parallel + "_40x40.py"
